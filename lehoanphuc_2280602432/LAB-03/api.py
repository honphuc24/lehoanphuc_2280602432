...
def rsa_encrypt():
    ...
    if key_type == 'public':
        ...
        return jsonify({'error': 'Ivalid key type'})
...
def rsa_decrypt():
    ...
    decrypt_cipher = rsa_cipher.decrypt(ciphertext,key)
    return jsonify({'decrypted_message':decrypt_cipher})
...
def rsa_sign_message():
    ...
    return jsonify({'decrypted_message':signature_hex})
...
def rsa_verify_signature():
    ...
    return jsonify({'decrypted_message':is_verified})
